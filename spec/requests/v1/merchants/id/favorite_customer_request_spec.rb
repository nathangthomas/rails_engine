...
describe 'Most Succerssful Transactions' do
  before(:each) do
    ...
    @invoice_3 = Invoice.create!(customer_id: @customer_1.id, merchant_id: @merchant_1.id, status: 'shipped')
    ...
    @transaction_3 = Transaction.create!(invoice_id: @invoice_3.id, credit_card_number: 9654405418234567, credit_card_expiration_date: '', result: 'successful')
  end

  it 'returns the customer that has conducted the most successful transactions' do
